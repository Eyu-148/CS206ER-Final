...
class Parallel_HILL_CLIMBER:
    ...
    def Print(self):
        ...
        for key in self.parents:
            # testA
            #print("Fitness: ", self.parents[key].fitness)
            # testB
    ...
    def Save_Values(self):
        # distance values for testA for each generation
        file = open("data/testB.txt", 'a')
        for p in self.parents:
            file.write(str(self.parents[p].maxDistance) + " ")
        file.write('\n')
        file.close()
