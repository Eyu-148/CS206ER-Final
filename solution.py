...
class SOLUTION:
    ...
    def Wait_For_Simulation_To_End(self):
        ...
        f1 = open("fitness" + str(self.myID) + ".txt", "r")
        # fitness values for testA
        #self.fitness = float(f1.readline())

        # fitness value for testB
        self.fitness.floating = float(f1.readline())
        self.fitness.distance = float(f1.readline())
        
        # get distance
        f2 = open("distance" + str(self.myID) + ".txt", "r")
        self.maxDistance = float(f2.readline())

        f1.close()
        f2.close()
        os.system("del fitness" + str(self.myID) + ".txt")
        os.system("del distance" + str(self.myID) + ".txt")
    ...
    def Create_Brain(self):
        ...
        # TODO: try cut the motors for the right/left FEET
