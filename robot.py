...
class ROBOT:
    ...
    def Get_Fitness(self):
        ...
        # get the coordinates on x-y plane
        ...
        # fitness function for testA
        #fitness = str((distance * maxTime) / (distance + maxTime))
        
        # fitness function for testB
        fitness = str(maxTime) + "\n" + str(distance)

        # writing fitness value to file
        ...
        with open("distance" + str(self.brainID) + ".txt", 'w') as f:
